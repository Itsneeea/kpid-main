                ...
                <div class="box box-info">
                    <div class="box-header">
                        <div class="btn-group pull-right">
                            ...
                            </button> <a href="hutang_print.php" target="_blank" class="btn btn-sm btn-primary"><i
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php echo date('d-m-Y', strtotime($d['hutang_tanggal'])); ?></td>
                                        <td><?php echo $d['hutang_keterangan']; ?></td>
                                        <td class="text-center">
                                            <?php echo "Rp. " . number_format($d['hutang_nominal']) . " ,-"; ?></td>
                                        <td>

                                            <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                data-target="#edit_hutang_<?php echo $d['hutang_id'] ?>">
                                                <i class="fa fa-cog"></i>
                                            </button>

                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#hapus_hutang_<?php echo $d['hutang_id'] ?>">
                                                <i class="fa fa-trash"></i>
                                            </button>


                                            <form action="hutang_update.php" method="post">
                                                <div class="modal fade" id="edit_hutang_<?php echo $d['hutang_id'] ?>"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <input type="hidden" name="id"
                                                                        value="<?php echo $d['hutang_id'] ?>">
                                                                    <input type="date" style="width:100%" name="tanggal"
                                                                        required="required"
                                                                        class="form-control datepicker2"
                                                                        value="<?php echo $d['hutang_tanggal'] ?>">
                                                                </div>
                                                                ...
                                                                <div class="form-group"
                                                                    ...
                                                                    <input type="number" style="width:100%"
                                                                        ...
                                                                        value="<?php echo $d['hutang_nominal'] ?>">
                                                                </div>
                                                                ...
                                                                <div class="form-group" style="width:100%">
                                                                    ...
                                                                    <textarea name="keterangan" style="width:100%"
                                                                        class="form-control"
                                                                        rows="4"><?php echo $d['hutang_keterangan'] ?></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary"
                                            ...
                                            <!-- modal hapus -->
                                            <div class="modal fade" id="hapus_hutang_<?php echo $d['hutang_id'] ?>"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">Tutup</button>
                                                            <a href="hutang_hapus.php?id=<?php echo $d['hutang_id'] ?>"
